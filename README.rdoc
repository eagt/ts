...
- git remote add origin http://git hub.com/eagt/(new repository neme).git
&
...
* To work on a branch and then push its updates to itself
First I need to get the branch on which I would like to work
- git  checkout branchname
- git add . (enter)
- git commit –m ”branch name”  (enter)
- git push –u origin branch name or simply git push  (enter)

TO send an ready branch to the original master
git merge branch name (enter)
